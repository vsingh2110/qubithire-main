      ...
      case 'scheduled':
        return (
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
              <p className="text-gray-600 dark:text-gray-400">No scheduled reports found.</p>
            </div>
          </div>
        );
      ...
      case 'revenue':
        return (
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
              <p className="text-gray-600 dark:text-gray-400">Revenue reports will be available here.</p>
            </div>
          </div>
        );
      ...
      case 'banking':
        return (
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
              <p className="text-gray-600 dark:text-gray-400">Banking and budgeting reports will be available here.</p>
            </div>
          </div>
        );
      ...
      case 'projects':
        return (
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
              <p className="text-gray-600 dark:text-gray-400">Project reports will be available here.</p>
            </div>
          </div>
        );
      ...
      case 'billables':
        return (
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
              <p className="text-gray-600 dark:text-gray-400">Time and billables reports will be available here.</p>
            </div>
          </div>
        );
      ...
      case 'purchases':
        return (
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
              <p className="text-gray-600 dark:text-gray-400">Purchase reports will be available here.</p>
            </div>
          </div>
        );
